...
fun setPictureOfDay(img:ImageView,pictureOfDay: PictureOfDay?)
{
    ...
    if(null!=pictureOfDay && pictureOfDay.url.isNotBlank()) {
        ...
        img.contentDescription= String.format(context.getString(
            R.string.nasa_picture_of_day_content_description_format
        ),pictureOfDay.title)
    }
    else{
        img.setImageResource(R.drawable.placeholder_picture_of_day)
        img.contentDescription= context.getString(
